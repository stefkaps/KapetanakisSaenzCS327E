...
def run(argv=None):	
	...
	with beam.Pipeline(options=PipelineOptions()) as p:
		...
		table_name = "kapetanakissaenzcs327e:zillow.Rental_Price_1Bedroom" # format: PROJECT:DATASET.TABLE
		...
		tuple_records | 'WriteTmpFile1' >> beam.io.WriteToText('/home/rsaenz8080/code/tuple_records', file_name_suffix='.txt')
	
		bigquery_records = tuple_records | 'CreateBigQueryRecord' >> beam.Map(create_bigquery_record)
	
		bigquery_records | 'WriteTmpFile2' >> beam.io.WriteToText('/home/rsaenz8080/code/bq_records', file_name_suffix='.txt')
